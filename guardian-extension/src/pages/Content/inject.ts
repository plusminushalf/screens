...
//   console.log(
//   if (document.querySelector('.text-dark.d-flex.align-items-center')) {
//     document.querySelector('.text-dark.d-flex.align-items-center').innerText =
//       'Guardian Safe';
//     done = done + 1;
//   }
//   if (
//     document.getElementById('btnMetamask') &&
//     document.getElementById('btnMetamask').children[1]
//   ) {
//     document.getElementById('btnMetamask').children[1].src =
//       'https://localhost:3000/logo.svg';
//     done = done + 1;
//   }
//   if (done == 2) clearTimeout(timeout);
// }, 300);
